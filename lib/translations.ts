...
export const UI: Record<Locale, UiText> = {
  fr: {
    appTitle: "Qui veut gagner... un José d'OR ?",
    appSubtitle: "10 questions. Un entonnoir de conversion. Un José d'or au bout.",
    ...
    almostTitle: "Presque !",
    almostMsg: "Dommage — le José d'OR ne se gagne que sans aucune erreur, et dans le temps imparti.",
    restartBtn: "Rejouer",
  ...
  en: {
    appTitle: "Who Wants to Win... a Golden José?",
    appSubtitle: "10 questions. A conversion funnel. A Golden José at the top.",
    ...
    almostMsg: "Too bad — the Golden José can only be won with a perfect score, within the time limit.",
  ...
  de: {
    appTitle: "Wer gewinnt... den goldenen José?",
    appSubtitle: "10 Fragen. Ein Conversion-Funnel. Ganz oben: der goldene José.",
    ...
    almostMsg: "Schade — den goldenen José gibt es nur mit einer fehlerfreien Runde, innerhalb der Zeit.",
  ...
  it: {
    appTitle: "Chi vuol vincere... un José d'Oro?",
    appSubtitle: "10 domande. Un funnel di conversione. Un José d'Oro in cima.",
    ...
    almostTitle: "Quasi!",
    almostMsg: "Peccato — il José d'Oro si vince solo con un punteggio perfetto, entro il tempo limite.",
    restartBtn: "Rigioca",
  ...
  es: {
    appTitle: "¿Quién quiere ganar... un José de Oro?",
    appSubtitle: "10 preguntas. Un embudo de conversión. Un José de Oro al final.",
    ...
    almostTitle: "¡Casi!",
    almostMsg: "Una pena — el José de Oro solo se gana sin ningún fallo, dentro del tiempo límite.",
...
export const QUESTIONS: Record<Locale, QuestionText[]> = {
  ...
  en: [
    ...
    { gain: "The Golden José", q: "Which sentence best sums up Perfmaker?", options: ["We interrupt visitors.", "We show pop-ups everywhere.", "We create the right interaction, at the right moment, for the right visitor.", "We hope for the best."], feedback: "🎉 Congratulations! You are now officially a « Certified Perfmaker Partner »." },
  ],
  de: [
  ...
  it: [
    ...
    { gain: "Il José d'Oro", q: "Quale frase riassume meglio Perfmaker?", options: ["Interrompiamo i visitatori.", "Mostriamo pop-up ovunque.", "Creiamo l'interazione giusta, al momento giusto, per il visitatore giusto.", "Speriamo che vada tutto bene."], feedback: "🎉 Congratulazioni! Sei ufficialmente un « Partner Certificato Perfmaker »." },
  ],
  es: [
    ...
    { gain: "El José de Oro", q: "¿Qué frase resume mejor a Perfmaker?", options: ["Interrumpimos a los visitantes.", "Mostramos pop-ups por todas partes.", "Creamos la interacción correcta, en el momento correcto, para el visitante correcto.", "Esperamos que todo salga bien."], feedback: "🎉 ¡Felicidades! Ahora eres oficialmente «Partner Certificado Perfmaker»." },
  ],
};
